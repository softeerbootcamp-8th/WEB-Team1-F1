...
public record DealDetailInfo(DealDetailRow detail, DealSide mySide, long viewerId,
                             LocalDateTime serverTime) {

    public static DealDetailInfo of(DealDetailRow detail, long viewerId, LocalDateTime serverTime) {
        return new DealDetailInfo(detail, detail.sideOf(viewerId), viewerId, serverTime);
    }
}
