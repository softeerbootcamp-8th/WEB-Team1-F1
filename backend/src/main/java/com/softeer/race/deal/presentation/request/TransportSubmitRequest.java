 ...
 */
@Schema(description = "서류·탁송 일정 제출")
public record TransportSubmitRequest(

        @Schema(description = "업로드한 서류 PDF 의 조회 주소")
        @NotBlank(message = "서류를 첨부해 주세요.")
        String documentUrl,

        @Schema(description = "차량을 넘기는 일시", example = "2026-08-20T14:00:00")
        @NotNull(message = "탁송 일시는 필수입니다.")
        LocalDateTime transportAt,

        @Schema(description = "출차 장소", example = "서울시 강남구 테헤란로 123")
        @NotBlank(message = "출차 장소는 필수입니다.")
