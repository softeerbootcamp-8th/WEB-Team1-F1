 ...
 */
@Schema(description = "업로드 주소 발급 응답")
public record UploadResponse(
    ...
    public static UploadResponse from(UploadInfo info) {
        return new UploadResponse(info.uploads().stream()
    ...
    public record PresignedUploadResponse(
            ...
            @Schema(description = "저장소 안의 객체 키. 이미지는 images/, 문서는 documents/ 아래에 놓입니다.",
            ...
            @Schema(description = "업로드 후 파일을 조회할 주소. 저장해 두어야 하는 값입니다.",
