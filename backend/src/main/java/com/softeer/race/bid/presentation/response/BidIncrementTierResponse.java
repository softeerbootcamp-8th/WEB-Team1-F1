...
public record BidIncrementTierResponse(
    ...
    public static BidIncrementTierResponse from(BidIncrementTier tier) {
        return new BidIncrementTierResponse(tier.getMinPrice(), tier.getIncrement());
    }
}