...
export const MOCK_AUCTIONS: AuctionCard[] = [
  {
    ...
    bidCount: 24,
    participantCount: 9,
    evaluationKeywords: ['무사고', '1인 신조', '정비 이력 완비'],
    startAt: iso(-40 * min),
  ...
  },
  {
    ...
    bidCount: 41,
    participantCount: 14,
    evaluationKeywords: ['풀옵션', '골격 이상 없음', '실내 상태 우수'],
    startAt: iso(-25 * min),
    endAt: iso(11 * min),
  },
  {
    ...
    bidCount: 0,
    participantCount: 6,
    evaluationKeywords: ['배터리 진단 우수', '무사고', '짧은 주행거리'],
    startAt: iso(28 * min),
  ...
  },
  {
    ...
    bidCount: 0,
    participantCount: 4,
    evaluationKeywords: ['실내 A급', '정비 완료', '주요 옵션 다수'],
    startAt: iso(2 * hour),
    endAt: iso(3 * hour),
  },
  {
    ...
    bidCount: 33,
    participantCount: 11,
    evaluationKeywords: ['하부 상태 우수', '짧은 주행거리', '비흡연 차량'],
    startAt: iso(-3 * hour),
    endAt: iso(-30 * min),
  },
  {
    ...
    bidCount: 19,
    participantCount: 8,
    evaluationKeywords: ['신차급', '무사고', '1인 신조'],
    startAt: iso(-5 * hour),
    endAt: iso(-2 * hour),
  },
]
